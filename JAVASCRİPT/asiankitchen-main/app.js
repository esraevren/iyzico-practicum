...
const categoryButtons=["All","Japan","China","Korea"]
...
categoryButtons.forEach(item=> {
 ...
 createButton.innerHTML=item;
 createButton.classList.add("btn", "btn-outline-dark", "btn-item");
 createButton.setAttribute("data-id",item)
 createButton.addEventListener('click',btnClick)
 buttonDom.append(createButton)
